...
{
// Constants
const byte CMarkerGraph::bkgIntencity = 50;

Mat CMarkerGraph::drawGraph(CBaseGraph * pGraph, CvPoint (*posFunc) (size_t nodeId, int size))
{
	const int		size	= 1000;
	CvPoint			pt1, pt2;
...
CvScalar CMarkerGraph::hsv2rgb(CvScalar hsv)
{
	double      hh, p, q, t, ff;
	long        i;
	CvScalar	out;
