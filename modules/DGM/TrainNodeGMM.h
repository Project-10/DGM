...
namespace DirectGraphicalModels
{
	...
	*/
	...
	private:
		...
		vec_NDGauss_t		* m_pvGausses;								// block of n-dimensional Gauss function	
		...
		inline Mat			  getDivergence(byte s, CNDGauss *x) const;	// Calculates devergence between the Gaussian <x> to all existing Gaussians
	};
}
