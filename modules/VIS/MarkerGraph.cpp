...
namespace DirectGraphicalModels { namespace vis
{
	...
	namespace {
		...
		void drawLine(Mat &img, Point pt1, Point pt2, Scalar color1, Scalar color2, int thikness = 1, int lineType = 8, int shift = 0)
		{
			const int nSegments = 8;

			Point2f Pt1 = static_cast<Point2f>(pt1);
			Point2f inc = static_cast<Point2f>(pt2 - pt1);
			inc.x /= nSegments;
			inc.y /= nSegments;
		...
		void drawTriangle(Mat &img, Point pt1, Point pt2, Point pt3, Scalar color, int lineType = 8, int shift = 0)
		{
		...
		// Draws an arrow
		void drawArrow(Mat &img, Point pt1, Point pt2, Scalar color, int lineType = 8, int shift = 0, double tipLength = 15)
		{
		...
		void drawArrowedLine(Mat &img, Point pt1, Point pt2, Scalar color, int thikness = 1, int lineType = 8, int shift = 0, double tipLength = 15)
		{
			line(img, pt1, pt2, color, thikness, lineType, shift);
			drawArrow(img, pt1, pt2, color, lineType, shift, tipLength);
		}

		void drawArrowedLine(Mat &img, Point pt1, Point pt2, Scalar color1, Scalar color2, int thikness = 1, int lineType = 8, int shift = 0, double tipLength = 15)
		{
